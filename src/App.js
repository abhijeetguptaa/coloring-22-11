...
const iconCategories = {
  "Farm Animals": [GiCow, GiPig, GiHorseHead, GiBarn, GiFarmer, GiDuck, FaTractor, GiCorn, FaCarrot, GiSprout, FaSeedling, GiBee,  GiSnail,  GiLadybug, GiAnt, GiCricket, FaLeaf, FaTools, FaWrench, FaScrewdriver, FaHammer, GiChicken, GiGoat, GiRooster, GiSheep, FaAppleAlt, FaBreadSlice, FaCheese, FaCookie, FaEgg, GiCarrot, GiBroccoli, GiTomato, GiChiliPepper, GiAubergine, GiGarlic, GiMushroom, GiPotato],
  "Pets": [FaDog, FaCat, FaPaw, GiSittingDog, GiCat,  FaBone, FaFish, FaDove, FaFeatherAlt, FaKiwiBird, FaFrog, FaSpider, GiSnake, GiLizardTongue,  GiSnail, GiButterfly, FaStethoscope, FaUserMd, FaMedkit, FaProcedures, FaHeartbeat, FaBandAid, FaSyringe, FaPills, FaFirstAid, FaClinicMedical, FaDog, FaCat, FaPaw, FaBone, FaFish, FaDove, FaFeatherAlt, FaKiwiBird, FaFrog, FaSpider, GiSnake, GiLizardTongue, GiButterfly, FaStethoscope, FaUserMd, FaMedkit, FaProcedures, FaHeartbeat, FaBandAid, FaSyringe, FaPills, FaFirstAid, FaClinicMedical],
  "Shapes": [
  ...
  "Vegetables": [GiCarrot, GiBroccoli, GiTomato, GiChiliPepper, GiCorn, FaCarrot, GiAubergine, GiGarlic,   GiPotato,  FaLeaf, FaSeedling, GiSprout, FaAppleAlt, FaBreadSlice, FaCheese, FaCookie, FaEgg, GiMushroom],
  ...
  "Food": [FaPizzaSlice, FaHamburger, FaIceCream, FaAppleAlt, FaBacon, FaBone, FaCandyCane, FaCarrot, FaCheese, FaCookie, FaCookieBite, FaDrumstickBite, FaEgg, FaHotdog, FaPepperHot, GiAppleCore, GiBanana, GiCheeseWedge, GiChickenOven, GiCupcake, GiDonut, GiFrenchFries, GiSteak,  FaPizzaSlice, FaHamburger, FaIceCream, FaBacon, FaBone, FaBreadSlice, FaCandyCane, FaCookieBite, FaDrumstickBite, FaHotdog, FaPepperHot, GiAppleCore, GiBanana, GiCheeseWedge, GiChickenOven, GiCupcake, GiDonut, GiFrenchFries, GiSteak],
  "Buildings": [FaBuilding, FaChurch, FaHospital, FaHotel, FaSchool, FaStore, FaUniversity, FaWarehouse, GiCastle, GiFactory, FaBook, FaPen, FaRuler,  FaBell, FaClipboard, FaGraduationCap, FaTools, FaWrench, FaScrewdriver, FaHammer, FaDraftingCompass, FaPaintRoller, FaBroom, FaBuilding, FaChurch, FaHospital, FaHotel,  FaStore, FaUniversity, FaWarehouse, GiCastle, GiFactory, FaBook, FaPen, FaRuler,  FaBell, FaClipboard, FaGraduationCap, FaDraftingCompass, FaPaintRoller, FaBroom, FaBuilding, FaChurch, FaHospital],
  ...
  "Nature": [FaLeaf, FaTree, FaFire, FaWater, FaMountain, FaIcicles, FaSnowflake, FaBolt, FaCloud, FaUmbrella, FaRainbow, FaSeedling, GiPineTree, GiFlowerPot, GiSprout, GiGrass, GiAcorn, GiMushroomCloud, GiVolcano, GiEarthAmerica, GiWaterfall, GiIsland, FaTree, FaFire, FaWater, FaMountain, FaIcicles, FaSnowflake, FaBolt, FaCloud, FaUmbrella, FaRainbow,  GiPineTree, GiFlowerPot, GiGrass, GiAcorn, GiMushroomCloud, GiVolcano, GiEarthAmerica, GiWaterfall, GiIsland]
};
